...
var Loading = function (_React$Component) {
  ...
  function Loading() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Loading.__proto__ || Object.getPrototypeOf(Loading)).call.apply(_ref, [this].concat(args))), _this), _this.renderLoading = function () {
...
var MemoryRouter = function (_React$Component) {
  ...
  function MemoryRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$4(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createMemoryHistory$1(_this.props), _temp), _possibleConstructorReturn$4(_this, _ret);
  }
...
var Redirect = function (_React$Component) {
  ...
  Redirect.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (locationsAreEqual$1(prevTo, nextTo)) {
...
var addBasename = function addBasename(basename, location) {
  ...
  return _extends$8({}, location, {
    pathname: addLeadingSlash$2(basename) + location.pathname
  });
};

var stripBasename$2 = function stripBasename(basename, location) {
  if (!basename) return location;

  var base = addLeadingSlash$2(basename);
...
var StaticRouter = function (_React$Component) {
  ...
  function StaticRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$8(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.createHref = function (path) {
      return addLeadingSlash$2(_this.props.basename + createURL(path));
  ...
  StaticRouter.prototype.render = function render() {
    ...
    var history = {
      ...
      action: "POP",
      location: stripBasename$2(basename, createLocation$1(location)),
...
var addLeadingSlash$3 = function addLeadingSlash(path) {
  return path.charAt(0) === '/' ? path : '/' + path;
};

var stripLeadingSlash$2 = function stripLeadingSlash(path) {
  return path.charAt(0) === '/' ? path.substr(1) : path;
};

var hasBasename$2 = function hasBasename(path, prefix) {
  return new RegExp('^' + prefix + '(\\/|\\?|#|$)', 'i').test(path);
};

var stripBasename$3 = function stripBasename(path, prefix) {
  return hasBasename$2(path, prefix) ? path.substr(prefix.length) : path;
};

var stripTrailingSlash$2 = function stripTrailingSlash(path) {
  return path.charAt(path.length - 1) === '/' ? path.slice(0, -1) : path;
};

var parsePath$2 = function parsePath(path) {
  var pathname = path || '/';
  var search = '';
  var hash = '';
...
var createPath$2 = function createPath(location) {
  var pathname = location.pathname,
      search = location.search,
      hash = location.hash;
...
var createLocation$2 = function createLocation(path, state, key, currentLocation) {
  var location = void 0;
  if (typeof path === 'string') {
    // Two-arg form: push(path, state)
...
var locationsAreEqual$2 = function locationsAreEqual(a, b) {
  return a.pathname === b.pathname && a.search === b.search && a.hash === b.hash && a.key === b.key && valueEqual(a.state, b.state);
};

var createTransitionManager$2 = function createTransitionManager() {
  var prompt = null;
...
var getConfirmation$2 = function getConfirmation(message, callback) {
 ...
 * changed to avoid false negatives for Windows Phones: https://github.com/reactjs/react-router/issues/586
 */
var supportsHistory$2 = function supportsHistory() {
  var ua = window.navigator.userAgent;
 ...
 * IE10 and IE11 do not.
 */
var supportsPopStateOnHashChange$2 = function supportsPopStateOnHashChange() {
  return window.navigator.userAgent.indexOf('Trident') === -1;
};
 ...
 * Returns false if using go(n) with hash history causes a full page reload.
 */
var supportsGoWithoutReloadUsingHash$2 = function supportsGoWithoutReloadUsingHash() {
  return window.navigator.userAgent.indexOf('Firefox') === -1;
};
 ...
 * containing undefined state when pressing the back button.
 */
var isExtraneousPopstateEvent$2 = function isExtraneousPopstateEvent(event) {
...
var PopStateEvent$2 = 'popstate';
var HashChangeEvent$3 = 'hashchange';

var getHistoryState$2 = function getHistoryState() {
  try {
    return window.history.state || {};
  } catch (e) {
    // IE 11 sometimes throws when accessing window.history.state
 ...
 * pushState, replaceState, and the popstate event.
 */
var createBrowserHistory$2 = function createBrowserHistory() {
  var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  invariant_1(canUseDOM$2, 'Browser history needs a DOM');

  var globalHistory = window.history;
  var canUseHistory = supportsHistory$2();
  var needsHashChangeListener = !supportsPopStateOnHashChange$2();

  var _props$forceRefresh = props.forceRefresh,
      forceRefresh = _props$forceRefresh === undefined ? false : _props$forceRefresh,
      _props$getUserConfirm = props.getUserConfirmation,
      getUserConfirmation = _props$getUserConfirm === undefined ? getConfirmation$2 : _props$getUserConfirm,
      _props$keyLength = props.keyLength,
      keyLength = _props$keyLength === undefined ? 6 : _props$keyLength;

  var basename = props.basename ? stripTrailingSlash$2(addLeadingSlash$3(props.basename)) : '';
  ...
  var getDOMLocation = function getDOMLocation(historyState) {
    ...
    warning_1$1(!basename || hasBasename$2(path, basename), 'You are attempting to use a basename on a page whose URL path does not begin ' + 'with the basename. Expected path "' + path + '" to begin with "' + basename + '".');

    if (basename) path = stripBasename$3(path, basename);

    return createLocation$2(path, state, key);
  };
  ...
  var transitionManager = createTransitionManager$2();

  var setState = function setState(nextState) {
    _extends$b(history, nextState);
  ...
  var handlePopState = function handlePopState(event) {
    // Ignore extraneous popstate events in WebKit.
    if (isExtraneousPopstateEvent$2(event)) return;

    handlePop(getDOMLocation(event.state));
  };

  var handleHashChange = function handleHashChange() {
    handlePop(getDOMLocation(getHistoryState$2()));
  };
  ...
  var initialLocation = getDOMLocation(getHistoryState$2());
  var allKeys = [initialLocation.key];

  // Public interface

  var createHref = function createHref(location) {
    return basename + createPath$2(location);
  };
  ...
  var push = function push(path, state) {
    ...
    var action = 'PUSH';
    var location = createLocation$2(path, state, createKey(), history.location);
  ...
  var checkDOMListeners = function checkDOMListeners(delta) {
    ...
    if (listenerCount === 1) {
      addEventListener(window, PopStateEvent$2, handlePopState);

      if (needsHashChangeListener) addEventListener(window, HashChangeEvent$3, handleHashChange);
    } else if (listenerCount === 0) {
      removeEventListener(window, PopStateEvent$2, handlePopState);

      if (needsHashChangeListener) removeEventListener(window, HashChangeEvent$3, handleHashChange);
    }
  };
...
var HashChangeEvent$4 = 'hashchange';

var HashPathCoders$2 = {
  hashbang: {
    encodePath: function encodePath(path) {
      return path.charAt(0) === '!' ? path : '!/' + stripLeadingSlash$2(path);
    },
    decodePath: function decodePath(path) {
      return path.charAt(0) === '!' ? path.substr(1) : path;
    }
  ...
  noslash: {
    encodePath: stripLeadingSlash$2,
    decodePath: addLeadingSlash$3
  },
  slash: {
    encodePath: addLeadingSlash$3,
    decodePath: addLeadingSlash$3
  }
};

var getHashPath$2 = function getHashPath() {
  // We can't use window.location.hash here because it's not
  // consistent across browsers - Firefox will pre-decode it!
  var href = window.location.href;
  var hashIndex = href.indexOf('#');
...
var pushHashPath$2 = function pushHashPath(path) {
  return window.location.hash = path;
};

var replaceHashPath$2 = function replaceHashPath(path) {
  var hashIndex = window.location.href.indexOf('#');

  window.location.replace(window.location.href.slice(0, hashIndex >= 0 ? hashIndex : 0) + '#' + path);
};

var createHashHistory$2 = function createHashHistory() {
  var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  invariant_1(canUseDOM$2, 'Hash history needs a DOM');

  var globalHistory = window.history;
  var canGoWithoutReload = supportsGoWithoutReloadUsingHash$2();
  ...
  var _HashPathCoders$hashT = HashPathCoders$2[hashType],
      encodePath = _HashPathCoders$hashT.encodePath,
      decodePath = _HashPathCoders$hashT.decodePath;


  var getDOMLocation = function getDOMLocation() {
    var path = decodePath(getHashPath$2());

    warning_1$1(!basename || hasBasename$2(path, basename), 'You are attempting to use a basename on a page whose URL path does not begin ' + 'with the basename. Expected path "' + path + '" to begin with "' + basename + '".');

    if (basename) path = stripBasename$3(path, basename);

    return createLocation$2(path);
  };

  var transitionManager = createTransitionManager$2();

  var setState = function setState(nextState) {
    _extends$c(history, nextState);
  ...
  var handleHashChange = function handleHashChange() {
    var path = getHashPath$2();
    var encodedPath = encodePath(path);

    if (path !== encodedPath) {
      // Ensure we always have a properly-encoded hash.
      replaceHashPath$2(encodedPath);
    } else {
      var location = getDOMLocation();
      var prevLocation = history.location;

      if (!forceNextPop && locationsAreEqual$2(prevLocation, location)) return; // A hashchange doesn't always == location change.

      if (ignorePath === createPath$2(location)) return; // Ignore this change; we already setState in push/replace.
  ...
  var revertPop = function revertPop(fromLocation) {
    ...
    var toIndex = allPaths.lastIndexOf(createPath$2(toLocation));

    if (toIndex === -1) toIndex = 0;

    var fromIndex = allPaths.lastIndexOf(createPath$2(fromLocation));
  ...
  if (path !== encodedPath) replaceHashPath$2(encodedPath);

  var initialLocation = getDOMLocation();
  var allPaths = [createPath$2(initialLocation)];

  // Public interface

  var createHref = function createHref(location) {
    return '#' + encodePath(basename + createPath$2(location));
  };
  ...
  var push = function push(path, state) {
    ...
    var action = 'PUSH';
    var location = createLocation$2(path, undefined, undefined, history.location);

    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      if (!ok) return;

      var path = createPath$2(location);
      var encodedPath = encodePath(basename + path);
      var hashChanged = getHashPath$2() !== encodedPath;
      ...
      if (hashChanged) {
        ...
        // is that other hash histories in the page will consider it a POP.
        ignorePath = path;
        pushHashPath$2(encodedPath);

        var prevIndex = allPaths.lastIndexOf(createPath$2(history.location));
        var nextPaths = allPaths.slice(0, prevIndex === -1 ? 0 : prevIndex + 1);
  ...
  var replace = function replace(path, state) {
    ...
    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      ...
      var prevIndex = allPaths.indexOf(createPath$2(history.location));
  ...
  var checkDOMListeners = function checkDOMListeners(delta) {
    ...
    if (listenerCount === 1) {
      addEventListener(window, HashChangeEvent$4, handleHashChange);
    } else if (listenerCount === 0) {
      removeEventListener(window, HashChangeEvent$4, handleHashChange);
    }
  };
...
function browserHistory(hashMode) {
  return hashMode ? createHashHistory$2() : createBrowserHistory$2();
}

var promiseSerial = function promiseSerial(funcs, props) {
  return funcs.reduce(function (promise, func) {
    return promise.then(function (result) {
      return func(props).then(Array.prototype.concat.bind(result));
    });
  }, Promise.resolve([]));
};
...
function makeCancelable(promise) {
  ...
  var wrappedPromise = new Promise(function (resolve, reject) {
    promise.then(function (val) {
      return hasCanceled ? reject(rejectErrorObject({ isCanceled: true })) : resolve(val);
    }).catch(function (error) {
      return hasCanceled ? reject(rejectErrorObject({ isCanceled: true })) : reject(error);
    });
  });
...
var AsyncComponent = function (_React$Component) {
  ...
  createClass(AsyncComponent, [{
    ...
    value: function componentDidMount() {
      ...
      this.chains.promise.then(function (data) {
        _this2.setState({
          data: verifyRouterData(data),
          resolvedSuccess: true
        });
      }).catch(function (error) {
        if (error && error.message && (_typeof(error.message) === 'object' && !error.message.isCanceled || typeof error.message === 'string' && error.message.indexOf('/') > -1)) {
    ...
    value: function renderChildren() {
      var _props2 = this.props,
          ...
          guardData = _props2.guardData;
      var data = this.state.data;


      return React.Children.map(children, function (child) {
        return React.cloneElement(child, { guardData: _extends$1({}, guardData, data) });
      });
    }
  }, {
    key: 'render',
...
AsyncComponent.propTypes = propTypes$1;
...
var Component = function Component(args) {
  var render = args.render,
      props = objectWithoutProperties(args, ['render']);


  return render(props);
};

var RouteGuard = function (_React$Component) {
  inherits(RouteGuard, _React$Component);
  ...
  function RouteGuard() {
    ...
    classCallCheck(this, RouteGuard);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = RouteGuard.__proto__ || Object.getPrototypeOf(RouteGuard)).call.apply(_ref, [this].concat(args))), _this), _this.renderChildren = function (props) {
      var _this$props = _this.props,
          render = _this$props.render,
          canActivate = _this$props.canActivate,
          guardData = _this$props.guardData;

      var newProps = _extends$1({}, props, { guardData: guardData });
  ...
  createClass(RouteGuard, [{
    key: 'renderAsync',
    value: function renderAsync(props) {
      var _props = this.props,
          render = _props.render,
          canActivate = _props.canActivate;


      return React.createElement(
        AsyncComponent,
        _extends$1({}, props, { promise: canActivate }),
        React.createElement(Component, _extends$1({}, props, { render: render }))
      );
    }
  }, {
    key: 'render',
...
RouteGuard.propTypes = propTypes$2;
RouteGuard.defaultProps = defaultProps$1;
...
RouteRedirect.propTypes = propTypes$3;
RouteRedirect.defaultProps = defaultProps$2;
  ...
  if (routes) {
    return React.createElement(
      ...
      routes.map(function (route, i) {
        if (route.redirect) {
          return React.createElement(RouteRedirect, {
            key: route.key || i,
            path: route.path,
            exact: route.exact,
            strict: route.strict,
        ...
        return React.createElement(RouteGuard, {
          key: route.key || i,
          path: route.path,
          exact: route.exact,
          strict: route.strict,
...
RouterGuard.propTypes = propTypes$4;
RouterGuard.defaultProps = defaultProps$3;

export { dynamicWrapper, RouterGuard, Link, Route, Redirect, Router, BrowserRouter, Switch, withRouter, NavLink, browserHistory as history };
